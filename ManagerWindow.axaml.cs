...
public partial class ManagerWindow : Window
{
    ...
    public ManagerWindow()
    {
        ...
        FilterCombo.SelectionChanged += (_, _) => ApplyFiltersAndRender();
    ...
    private async Task LoadCategoriesAsync()
    {
        ...
        FilterCombo.ItemsSource = categories;
    ...
    private void ApplyFiltersAndRender()
    {
        ...
        var cat = (FilterCombo.SelectedItem?.ToString()) ?? string.Empty;
    ...
    {
        var home = new ManagerHomeWindow();
        home.Show();
        Close();
    }
